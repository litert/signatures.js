...
(async () => {
    ...
    if (LibSig.RSA.verify(
        ...
        console.log('[rsa-pss-sha256] Signature verification passed.');
    }
    else {

        console.error('[rsa-pss-sha256] Signature verification failed.');
    }
    ...
    if (await LibSig.RSA.verifyStream(
        ...
        console.log('[rsa-pss-sha512-stream] Signature verification passed.');
    }
    else {

        console.error('[rsa-pss-sha512-stream] Signature verification failed.');
    }
    ...
    if (rsaS384Signer.verify(CONTENT, sigRsaS384)) {
        ...
        console.log('[rsa-pss-sha384] Signature verification passed.');
    }
    else {

        console.error('[rsa-pss-sha384] Signature verification failed.');
    }
    ...
    if (await rsaS384Signer.verifyStream(
        ...
        console.log('[rsa-pss-sha384-stream] Signature verification passed.');
    }
    else {

        console.error('[rsa-pss-sha384-stream] Signature verification failed.');
    }
